...
| --- | --- | --- | --- | --- |
| P2-SWEEP-LLAMA32-CHAT | sweep | Llama-3.2-1B | Chat (512:256) | Max Throughput (OTPS/TTPS) |
| P2-SWEEP-LLAMA32-RAG | sweep | Llama-3.2-1B | RAG (4096:512) | KV Cache Efficiency / TTFT Scaling |
| P2-SWEEP-QWEN06-CODE | sweep | Qwen/Qwen3-0.6B | CodeGen (512:4K) | Decoding Efficiency (ITL) Long Output |
| P2-SWEEP-GRANITE32-RAG | sweep | granite-3.2-2b-instruct | RAG (4096:512) | Prefill TTFT Scaling (Enterprise) |
| P2-SWEEP-OPT125M-SUMM | sweep | facebook/opt-125m | Summarization (1024:256) | Balanced Throughput (Legacy) |
| P2-SWEEP-QWEN06-CHAT | sweep | Qwen/Qwen3-0.6B | Chat (512:256) | Max Throughput (Efficient Model) |
| P2-SWEEP-GRANITE32-CHAT | sweep | granite-3.2-2b-instruct | Chat (512:256) | Max Throughput (Enterprise) |
...
| Test ID | Test Type | Model | Workload | Primary Metric Focus |
| --- | --- | --- | --- | --- |
| P2-SYNC-TINY11-CHAT | synchronous | TinyLlama-1.1B | Chat (512:256) | Raw Baseline Latency (No Contention) |
...
| --- | --- | --- | --- | --- | --- |
| P2-POISSON-QWEN06-CODE | poisson | Qwen/Qwen3-0.6B | CodeGen (512:4K) | 60% of Max (from P2-SWEEP-QWEN06-CODE) | Responsiveness to Code Bursts |
| P2-POISSON-GRANITE32-CHAT | poisson | granite-3.2-2b-instruct | Chat (512:256) | 60% of Max (from P2-SWEEP-GRANITE32-CHAT) | Responsiveness to Bursty Traffic |
