...
| --- | --- | --- | --- | --- |
| 2.1 | sweep | Llama-3.2-1B | Chat (512:256) | Max Throughput (OTPS/TTPS) |
| 2.2 | sweep | Llama-3.2-1B | RAG (4096:512) | KV Cache Efficiency / TTFT Scaling |
| 2.3 | sweep | Qwen/Qwen3-0.6B | CodeGen (512:4K) | Decoding Efficiency (ITL) Long Output |
| 2.4 | sweep | granite-3.2-2b-instruct | RAG (4096:512) | Prefill TTFT Scaling (Enterprise) |
| 2.5 | sweep | facebook/opt-125m | Summarization (1024:256) | Balanced Throughput (Legacy) |
| 2.6 | sweep | Qwen/Qwen3-0.6B | Chat (512:256) | Max Throughput (Efficient Model) |
| 2.7 | sweep | granite-3.2-2b-instruct | Chat (512:256) | Max Throughput (Enterprise) |
...
| Test ID | Test Type | Model | Workload | Primary Metric Focus |
| --- | --- | --- | --- | --- |
| 2.8 | synchronous | TinyLlama-1.1B | Chat (512:256) | Raw Baseline Latency (No Contention) |
...
| --- | --- | --- | --- | --- | --- |
| 2.9 | poisson | Qwen/Qwen3-0.6B | CodeGen (512:4K) | 60% of Max (from 2.3) | Responsiveness to Code Bursts |
| 2.10 | poisson | granite-3.2-2b-instruct | Chat (512:256) | 60% of Max (from 2.7) | Responsiveness to Bursty Traffic |
...
| Test ID | Test Type | Model | Workload | Primary Metric Focus |
| --- | --- | --- | --- | --- |
| 2.11 | sweep | slate-125m-english-rtrvr-v2 | Embedding (512:1) | English Embedding Throughput |
| 2.12 | sweep | granite-embedding-278m-multilingual | Embedding (512:1) | Multilingual Embedding Throughput |
